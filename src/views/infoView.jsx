    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style = {{}}>
              ...
              <View style = {{padding: 15}}><Text style = {{fontSize: 15}}>The criteria for bload donation are very braod and there are many varying conditions according to defferent sources. For the purposes of out application we will refer to an official document from the Association for the Advancement of Blood & Biotherapies. However these conditions vary from one hospital to another, and you can get in touch with the hospital at any time for any clarifications.</Text></View>
