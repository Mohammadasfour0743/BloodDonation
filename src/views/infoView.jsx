    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style = {{}}>
              ...
              <View style = {{padding: 15}}><Text style = {{fontSize: 15}}>There are broad criteria for blood donation, and the conditions are many, but they are all unified in an <Text style = {{color: "#9a4040", fontSize: 15, textDecorationLine: "underline"}} onPress={() => Linking.openURL("https://www.aabb.org/for-donors-patients/about-blood-donation")}>official document from the Association for the Advancement of Blood & Biotherapies</Text>. However these conditions vary from one hospital to another, and you can get in touch with the hospital at any time for any clarifications.</Text></View>
              <View style = {{padding: 15}}><Text style = {{fontSize: 15}}>Not everyone is eligible for blood donation, there are many reasons why you may not be able to donate, but these reasons fall into two main categories: Risks to your health and/or risks to the health of the patient.</Text></View>
        ...
        <View style = {{justifyContent: "center", alignItems: "center", padding: 10, marginTop: 20}}>
          <Text style = {{fontFamily: "Roboto-bold", fontSize: 20, color: "#9a4040"}}>How to use BloodShare</Text>
        </View>
        <View style = {{gap: 15, padding: 15}}>
          <Text>To donate blood, check BloodShare for current requests from hospitals in your area. When you find a valid request, you can click respond and the hospital will be alerted. Use the link provided in the request to navigate to the hospital. </Text>
          <View style = {{justifyContent: "center", alignItems: "center", padding: 10, marginTop: 20}}>
          <Text style = {{fontFamily: "Roboto-bold", fontSize: 20, color: "#9a4040"}}>Before You Donate</Text>
          </View>
          <Text>You can take a few steps to prepare yourself before your donation, including: </Text>
          <Text style={{ marginLeft: 10 }}>{"\u2022"} Don't forget your ID card</Text>
          <Text style={{ marginLeft: 10 }}>{"\u2022"} Eat healthy, drink lots of fluids, and stay hydrated!</Text>
          <Text style={{ marginLeft: 10 }}>{"\u2022"} Get a good night's sleep</Text>
          <Text style={{marginLeft: 10}}>{"\u2022"}Avoid alcohol the night before, happy hour can wait!</Text>
          <Text style={{marginLeft: 10}}>{"\u2022"}If you're a regular smoker, take a break for a couple of hours</Text>
        </View>
        <View style = {{justifyContent: "center", alignItems: "center", padding: 10, marginTop: 20}}>
        ...
        <View style = {{gap: 15, padding: 15}}>
          ...
          <Text> During the donation process, you will donate one unit of blood; this takes about <Text style={{fontWeight: "bold"}}>six to ten minutes</Text>.</Text>
        </View>
        <View style = {{justifyContent: "center", alignItems: "center", padding: 10, marginTop: 20}}>
          <Text style = {{fontFamily: "Roboto-bold", fontSize: 20, color: "#9a4040"}}>Post-Donation</Text>
        </View>
        <View style = {{gap: 15, padding: 15}}>
          <Text> After donating, it is recommended that you do the following: </Text>
          <Text style={{ marginLeft: 10 }}>{"\u2022"} Increase your fluid intake for the next <Text style={{fontWeight: "bold"}}>24 hours</Text></Text>
          <Text style={{ marginLeft: 10 }}>{"\u2022"} Avoid physical exertion or heavy lifting, especially on the donation arm for the next <Text style={{fontWeight: "bold"}}>5 hours</Text></Text>
          <Text style={{ marginLeft: 10 }}>{"\u2022"} Eat well balanced meals for the next<Text style={{fontWeight: "bold"}}> 24 hours</Text></Text>
          <Text style={{ marginLeft: 10 }}>{"\u2022"} Smoking and drinking are not recommended directly after a donation</Text>
          <Text style={{marginTop: 40}}> If you experience discomfort or light-headed after donating, lie down until the feeling passes.</Text>
          <Text>If some bleeding occurs after removal of the bandage, apply pressure to the site and raise your arm for three to five minutes.</Text>
          <Text>If bruising or bleeding appears under the skin, apply a cold pack periodically to the bruised area during the first 24 hours, then warm, moist heat intermittently.</Text>
        </View>
        <View style = {{marginBottom: 100, marginLeft: 15}}>
          <Text style = {{color: "#9a4040", fontSize: 15, textDecorationLine: "underline", padding: 10, textAlign: "left"}} onPress={() => Linking.openURL("https://www.redcrossblood.org/")}>Learn more on the Red Cross website</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  )
